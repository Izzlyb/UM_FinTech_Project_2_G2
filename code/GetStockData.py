...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
def get_portfolio_assets_symbols(portfolio_df):
    return get_tickers_from_df(portfolio_df)
        
#------------------------------------------------------------------------
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
def get_portfolio_assets_quantities(portfolio_df):
    tkrs_qty = []

    for i in range(len(portfolio_df)):
        tkrs_qty.append(portfolio_df.loc[i]['Quantity'])
